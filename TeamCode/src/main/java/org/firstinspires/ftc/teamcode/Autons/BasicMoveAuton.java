...
//        move.setLinearHeadingInterpolation(startPose.getHeading(), scorePose.getHeading());
        ...
        path5 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(-20,-12),new Pose(-60, -12)))
        ...
        path9 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(-50,-36),new Pose(-36, 0)))
    ...
    public void autonomousPathUpdate() {
        switch (Pathstate) {
            ...
            case SHOOT1:
                    if (pathTimer.seconds() < 3.5 && pathTimer.seconds() > 1) {

                        shootBall = true;
                    } else if (pathTimer.seconds() >= 3.5) {
...
////            shoot.flyWheelActivated = !shoot.flyWheelActivated;
        ...
        if(shootBall) {
            ...
            if (Math.abs(shooter.flyWheelMotor1.getVelocity() - shooter.speed) < 50) {
                intake.turretSpinIntake = true;
