...
public class Blue18Close extends OpMode{
    ...
    public void buildPaths() {
        ...
        Path5 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(20.000-72, 66.000-72),
                                new Pose(18.000-72, 60.000-72),
                                new Pose(14.000-72, 62.000-72)
                        )
        ...
        Path9 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(52.000-72, 92.000-72),
                                new Pose(39.000-72, 69.000-72),
                                new Pose(18.000-72, 66.000-72)
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(180))
        ...
        Path10 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(18.000-72, 66.000-72),
                                new Pose(18.000-72, 54.000-72),
                                new Pose(9.000-72, 54.000-72)
                        )
        ...
        Path11 = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(100), Math.toRadians(235))
        ...
        Path12 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(52.000-72, 92.000-72),
                                new Pose(57.000-72, 30.000-72),
                                new Pose(21.000-72, 39.000-72)
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(180))
                .build();
        ...
        Path13 = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(21.000-72, 36.000-72),

                                new Pose(60-72, 110-72)
                        )
