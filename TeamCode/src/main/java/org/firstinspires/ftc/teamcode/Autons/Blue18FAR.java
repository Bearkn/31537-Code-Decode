...
public class Blue18FAR extends OpMode{
    ...
    private final Pose startPose = new Pose(-24.5, -63, Math.toRadians(180)); // Start Pose of our robot.
...
//                    .addTemporalCallback(1500, () -> {setPathState(PathState.SHOOT1);})
            ...
            grab3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(54.000-72, 9.000-72),
                                    new Pose(50.000-72, 40.000-72),
                                    new Pose(11.000-72, 36.000-72)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
            ...
            GRABCORNER2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(54.000-72, 9.000-72),
                                    new Pose(39.000-72, 20.000-72),
                                    new Pose(12.000-72, 20.000-72)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
